...
from .arpes_maps import apply_kpath_ticks
...
def list_band_scatter_presets() -> Tuple[str, ...]:
    ...
    :see: :class:`~.test_band_scatter.TestListBandScatterPresets`
...
def plot_band_scatter_preset(  # noqa: PLR0913, PLR0917
    ...
    :see: :class:`~.test_band_scatter.TestPlotBandScatterPreset`
...
def plot_band_scatter_with_kpath(  # noqa: PLR0913, PLR0917
    ...
    :see: :class:`~.test_band_scatter.TestPlotBandScatterWithKpath`
