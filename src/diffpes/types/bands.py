...
Extended Summary
----------------
This module defines the electronic band-structure carriers and the
orbital-resolved projections that ARPES simulations consume.
...
from diffpes.constants import N_ORBITALS, N_SPIN_COMPONENTS
