...
def faddeeva(  # noqa: DOC502 -- eqx.error_if raises under JAX execution.
    ...
    :see: :class:`~.test_numerics.TestFaddeeva`
...
def pack_complex(
    ...
    :see: :class:`~.test_numerics.TestPackComplex`
...
def unpack_complex(
    ...
    :see: :class:`~.test_numerics.TestUnpackComplex`
...
def zscore_normalize(
    ...
    **Implementation details:**
    ...
    :see: :class:`~.test_numerics.TestZscoreNormalize`
