r"""Define shared physical, numerical, orbital, and parser constants.

Extended Summary
----------------
This module owns constants that several scientific or input subpackages use.
CODATA physical constants fix the unit system from the conventions charter.
The system uses eV for energies and Angstrom for lengths. Shared parser tokens,
orbital conventions, dimensions, and tolerances also live here.
...
The module exports each public constant directly through
:mod:`diffpes.constants`. Private constants support source modules without
creating additional public API names.
...
The package configures JAX before it imports this module.
"""
