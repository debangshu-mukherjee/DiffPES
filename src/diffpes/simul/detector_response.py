...
Extended Summary
----------------
This module applies the background, sensitivity, and bin volume.
It also applies the exposure and the post-count response.
...
def detector_bin_volumes(
    ...
    :see: :class:`~.test_detector_response.TestDetectorBinVolumes`
...
def background_density(  # noqa: DOC503
    ...
    :see: :class:`~.test_detector_response.TestBackgroundDensity`
...
def sensitivity_field(  # noqa: DOC503
    ...
    :see: :class:`~.test_detector_response.TestSensitivityField`
...
def apply_post_count_response(  # noqa: DOC503
    ...
    :see: :class:`~.test_detector_response.TestApplyPostCountResponse`
...
def expected_counts(  # noqa: DOC502
    ...
    :see: :class:`~.test_detector_response.TestExpectedCounts`
