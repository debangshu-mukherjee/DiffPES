...
def main() -> None:
    ...
    source_paths: Tuple[str, ...] = (
        ...
        "src/diffpes/simul/_detector_cube.py",
        "src/diffpes/simul/_detector_geometry.py",
        "src/diffpes/simul/_detector_spectrum.py",
        "src/diffpes/simul/_kramers_kronig.py",
        "src/diffpes/simul/_kz_spectrum.py",
        "src/diffpes/simul/_principal_value.py",
        "src/diffpes/simul/_source_carriers.py",
        "src/diffpes/simul/_spectrum_stream.py",
        "src/diffpes/simul/_spectrum_validation.py",
        "src/diffpes/simul/spectrum.py",
        "src/diffpes/simul/counting.py",
        "src/diffpes/simul/detector_response.py",
        ...
        "src/diffpes/simul/kz_broadening.py",
        "src/diffpes/simul/resolution.py",
        "src/diffpes/simul/transmission.py",
        ...
        "src/diffpes/constants/certification.py",
        "src/diffpes/constants/numerical.py",
        "src/diffpes/constants/shared.py",
        "src/diffpes/constants/wannier.py",
        ...
        "src/diffpes/radial/coulomb_functions.py",
        "src/diffpes/radial/coulomb_numerov.py",
        "src/diffpes/radial/coulomb_ode.py",
        ...
        "src/diffpes/types/arpes.py",
        "src/diffpes/types/experiment.py",
        "src/diffpes/types/bands.py",
        "src/diffpes/types/detector_data.py",
