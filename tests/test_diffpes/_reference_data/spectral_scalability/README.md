...
The recorded high-water values were `428,138,496` bytes before and `658,485,248`
bytes after the literal-target compile. The executable companions had not run.
Compilation took `5.386575` seconds on the recorded TFRT CPU host. The compact
