...
class TestFaddeeva(chex.TestCase):
    """Validate :func:`diffpes.maths.numerics.faddeeva`.
    ...
    :see: :func:`~diffpes.maths.faddeeva`
    """
...
class TestZscoreNormalize(chex.TestCase):
    """Validate :func:`diffpes.maths.numerics.zscore_normalize`.
    ...
    :see: :func:`~diffpes.maths.zscore_normalize`
    """
...
class TestPackComplex(chex.TestCase):
    """Validate :func:`~diffpes.maths.numerics.pack_complex`.
    ...
    :see: :func:`~diffpes.maths.pack_complex`
    """
...
class TestUnpackComplex(chex.TestCase):
    """Validate :func:`~diffpes.maths.numerics.unpack_complex`.
    ...
    :see: :func:`~diffpes.maths.unpack_complex`
    """
