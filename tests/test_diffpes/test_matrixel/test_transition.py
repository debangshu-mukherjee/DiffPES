"""Validate coherent orbital and band transition channels.
...
class TestResolveOrbitalPositionsCart:
    """Validate :func:`diffpes.matrixel.resolve_orbital_positions_cart`.

    :see: :func:`diffpes.matrixel.resolve_orbital_positions_cart`
    """
...
class TestRealSphericalHarmonicsCartesianAll:
    ...
    :see: :func:`diffpes.matrixel.real_spherical_harmonics_cartesian_all`
    """
...
class TestOrbitalTransitionChannels:
    ...
    :see: :func:`diffpes.matrixel.orbital_transition_channels`
    """
...
class TestContractPolarization:
    """Validate :func:`diffpes.matrixel.contract_polarization`.

    :see: :func:`diffpes.matrixel.contract_polarization`
    """
...
class TestTransitionSource:
    """Validate :func:`diffpes.matrixel.transition_source`.

    :see: :func:`diffpes.matrixel.transition_source`
    """
...
class TestProjectBandChannels:
    """Validate :func:`diffpes.matrixel.project_band_channels`.

    :see: :func:`diffpes.matrixel.project_band_channels`
    """
...
class TestMatrixElementIntensity:
    ...
    :see: :func:`diffpes.matrixel.matrix_element_intensity`
    """
...
class TestAssembleOrbitalTransitionChannels:
    ...
    :see: :func:`diffpes.matrixel.assemble_orbital_transition_channels`
    """
