"""Bind and inspect the inert kz quadrature-convergence evidence.
...
_ARTIFACT_PATH: Path = _REFERENCE_DIRECTORY / "kz_quadrature_convergence.json"
_MANIFEST_PATH: Path = (
    _REFERENCE_DIRECTORY / "kz_quadrature_convergence_manifest.json"
)
_ARTIFACT_SHA256: str = (
    "16ecee54c5e3ef04536b937fb67f103f9141eb64f9b8a6986367928de6f7147f"
)
_MANIFEST_SHA256: str = (
    "ef3933954ea4b58946138605e4b2715935d394e445d96d721967204f9614e830"
)
_GENERATOR_SHA256: str = (
    "3658d7df5c74c0c748bf67e3f9bee5cff852a3ef5516041930993da19fe5764b"
)
_GENERATOR_NAME: str = "generate_kz_quadrature_convergence.py"
_AUTHORITY_ARTIFACT_NAME: str = "kz_quadrature_convergence.json"
...
def test_kz_quadrature_convergence_has_authenticated_authority() -> None:
    ...
    assert manifest["artifact"] == {
        "path_from_diffpes_root": (
            "tests/test_diffpes/_reference_data/kz_quadrature_convergence.json"
        ),
        "sha256": _ARTIFACT_SHA256,
    }
    assert manifest["authority_artifact"] == {
        "name": _AUTHORITY_ARTIFACT_NAME,
        "sha256": _ARTIFACT_SHA256,
    }
    ...
    assert artifact["generator"]["name"] == _GENERATOR_NAME
    assert artifact["generator"]["sha256"] == _GENERATOR_SHA256


def test_kz_quadrature_convergence_freezes_the_selected_node_count() -> None:
    """Require the full convergence profile and measured 2048-node selection.
    ...
    assert artifact["artifact_id"] == "kz-quadrature-convergence-v1"
    assert artifact["requirements"] == [
        "wrapped-kz-line-shape",
        "kz-quadrature-convergence",
        "surface-reciprocal-covariance",
        "mean-free-path-differentiability",
        "inner-potential-kinematic-differentiability",
    ]
...
def test_kz_quadrature_convergence_covers_reference_and_geometry_truth() -> (
    None
):
