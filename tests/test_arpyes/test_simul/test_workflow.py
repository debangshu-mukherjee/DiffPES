"""Tests for high-level workflow helpers in :mod:`arpyes.simul.workflow`."""
...
class TestLoadVaspContext(chex.TestCase):
    """Tests for :func:`arpyes.simul.load_vasp_context`."""
...
class TestPrepareProjection(chex.TestCase):
    """Tests for :func:`arpyes.simul.prepare_projection`."""
...
class TestSimulateContext(chex.TestCase):
    """Tests for :func:`arpyes.simul.simulate_context`."""
...
class TestRunVaspWorkflow(chex.TestCase):
    """Tests for :func:`arpyes.simul.run_vasp_workflow`."""
